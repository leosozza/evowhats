...
export const connectInstance = (name: string) => evo(P_CONNECT, "POST", { instanceName: name });
export const getStatus = (name: string) => evo(P_STATUS, "POST", { instanceName: name });
export const getQr = (name: string) => evo(P_QR, "POST", { instanceName: name });
